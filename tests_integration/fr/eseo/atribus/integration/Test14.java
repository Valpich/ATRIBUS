...
public class Test14 {
  ...
  public void test14() throws Exception {
    ...
    Thread.sleep(2000);
    driver.findElement(By.linkText("Afficher les compétences d'une matière")).click();
    Thread.sleep(2000);
    driver.findElement(By.linkText("Afficher les compétences d'une unité d'enseignement")).click();
    Thread.sleep(2000);
    driver.findElement(By.xpath("//button[@type='submit']")).click();
    Thread.sleep(2000);
    driver.findElement(By.xpath("//button[@type='submit']")).click();
