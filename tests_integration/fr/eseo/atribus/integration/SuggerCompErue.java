...
public class SuggerCompErue {
  ...
  @Test
  public void testSuggerCompErue() throws Exception {
    driver.get(baseUrl + "/ATRIBUS/");
    driver.findElement(By.linkText("Compétences")).click();
    driver.findElement(By.linkText("Suggerer compétence (ERUE)")).click();
    driver.findElement(By.id("competence")).clear();
    driver.findElement(By.id("competence")).sendKeys("Soutenance");
    driver.findElement(By.id("commentaire")).clear();
    driver.findElement(By.id("commentaire")).sendKeys("Savoir présenter un projet");
