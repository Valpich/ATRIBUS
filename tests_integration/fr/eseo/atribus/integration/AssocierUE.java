...
public class AssocierUE {
  ...
  @Test
  public void testAssocierUE() throws Exception {
    driver.get(baseUrl + "/ATRIBUS/");
    driver.findElement(By.linkText("Unités d'enseignement")).click();
    driver.findElement(By.linkText("Associer des compétences d'une unité d'enseignement")).click();
