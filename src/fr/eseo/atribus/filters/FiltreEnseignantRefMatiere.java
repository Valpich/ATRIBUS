 ...
 */
public class FiltreEnseignantRefMatiere implements Filter {
   ...
   * Constructeur.
   */
  public FiltreEnseignantRefMatiere() {
    super();
  }
  ...
  public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
     ...
     * connecté.
     */
    if (session.getAttribute(FiltreEnseignantRefMatiere.ATT_SESSION_USER) == null) {
      reponse.sendRedirect(requete.getContextPath() + FiltreEnseignantRefMatiere.ACCES_PUBLIC);
    } else {
      @SuppressWarnings("unchecked")
      final List<Utilisateur> listeUtilisateur =
          (List<Utilisateur>) session.getAttribute(FiltreEnseignantRefMatiere.ATT_SESSION_USER);
