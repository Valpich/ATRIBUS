...
/**
 * Servlet d'implementation de la classe RessourceController.
 */
@Controller
public class RessourceController {

  /** La constante VUE_MODIFIER. */
  private static final String VUE_MODIFIER = "EnseignantRefMatiere/modifierRessource";

  /** La constante VUE_TELECHARGER. */
  private static final String VUE_TELECHARGER = "download";

  /** La constante VUE_ELEVE_CONSULTER. */
  private static final String VUE_ELEVE_CONSULTER = "Eleve/consulterRessource";

  /** La constante VUE_UPLOAD. */
  private static final String VUE_UPLOAD = "upload";

  /** La constante ATT_RESSOURCES. */
  private static final String ATT_RESSOURCES = "ressources";

  /** La constante ATT_FORM. */
  private static final String ATT_FORM = "form";

  /** La constante ATT_COMPETENCES. */
  private static final String ATT_COMPETENCES = "competences";
  ...
  private static final String FICHIER_PROPERTIES = "upload.properties";

  /**
   * Accesseur en lecture du paramètre base path.
   *
  ...
  /**
   * Accesseur en écriture du paramètre base path.
   *
  ...
  /**
   * Accesseur en lecture du paramètre serveur path.
   *
  ...
  /**
   * Accesseur en écriture du paramètre serveur path.
   *
  ...
  /**
   * Accesseur en lecture du paramètre temp folder.
   *
  ...
  /**
   * Accesseur en écriture du paramètre temp folder.
   *
  ...
  private void validerFichierServeur() throws ServletException {
    if (this.serveurPath == null || this.tempFolder == null) {
      ...
      final File path = new File(this.serveurPath + File.separator + this.tempFolder);
      path.mkdir();
    }
  }
  ...
  /**
   * Accesseur en lecture du paramètre file.
   *
  ...
  private void downloadFichier(HttpServletRequest request, HttpServletResponse response) {
    try {
      ...
      this.envoyerFichier(response, nom + '.' + type, file);
    } catch (final IOException ioe) {
   ...
   *
   * @param response la response
   * @param choixPromotion le choix de promotion
   * @param dateDebut le date de debut
   * @param dateFin le date de fin
   */
   ...
   * Eviter les doublons.
   *
   * @param listeRessourcesErm la liste ressources erm
  ...
  /**
   * Accesseur en lecture du paramètre valeur champ.
   *
   * @param request la requete
