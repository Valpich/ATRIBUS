...
<title>Supprimer un examen</title>
					...
					<div class="col-md-6 col-sm-6 col-xs-12">
						<div class="x_panel tile">
							<div class="x_title">
								...
								<h2>Supprimer un examen via ce formulaire</h2>
							...
							<div class="x_content">
								<br>
								<form method="post" action="SupprimerExamen">
									...
									<c:choose>
										...
										<c:when test="${not empty examens }">
											<div class="text-center">
												<div style="font-size: 14px; margin-bottom: 12px;">
													Merci de choisir un examen à supprimer</div>
													...
													<c:forEach var="examen" items="${examens}">
														<c:if test="${examen.autoEvaluation == false}">
															<option value="<c:out value="${examen.nom}"/>">
																<c:out
																	value="Examen ${examen.nom} [${examen.matiere.nom}]" />
															</option>
														</c:if>
														<c:if test="${examen.autoEvaluation == true}">
															<option value="<c:out value="${examen.nom}"/>">
																<c:out
																	value="Auto Evaluation ${examen.nom} [${examen.matiere.nom}]" />
															</option>
														</c:if>
													</c:forEach>
												</select>
												<br />
												<button type="submit" class="btn btn-success btn-block ">Supprimer
													l'examen</button>
											</div>
