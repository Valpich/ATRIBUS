...
<script>
	...
	function ajouter_competence() {
		...
		divtest.innerHTML = '<div class="col-md-8 col-sm-8 col-xs-12" style="margin-left: -10px;"><select class="form-control" name="choixCompetence'+comp+'" id="choixCompetence'+comp+'"> <c:forEach var="competence" items="${ competences}"> <option value="<c:out value="${competence.nom}"/>"><c:out value="${competence.nom}" /></option> </c:forEach> </select></div><div class="col-md-4 col-sm-4 col-xs-12 input-group"><input  class="form-control" type="number" id="pourcentage'+comp+'" name="pourcentage'+comp+'" value="0" size="20" maxlength="30" step="1" min="0" max="100" /><div class="input-group-addon">%</div></div>'
					...
					<div class="col-md-6 col-sm-6 col-xs-12">
						<div class="x_panel tile">
							<div class="x_title">
								...
								<h2>Ajouter un exercice via ce formulaire</h2>
							...
							<div class="x_content">
								...
								<form method="post" action="AjouterExercice">

									<c:choose>
										<c:when test="${form.getData().erreurs['nom'] != null}">
											<div class="alert alert-danger alert-dismissible fade in"
												...
												<c:out value="${form.getData().erreurs['nom']}" />
											</div>
										</c:when>
									...
									<c:if test="${form.getData().resultat == 'success'}">
									...
									<c:if test="${form.getData().resultat == 'error'}">
										<div class="form-group">
											<div class="alert alert-danger alert-dismissible fade in"
												style="text-shadow: 0 0px 0 #fff;" role="alert">
												<button type="button" class="close" data-dismiss="alert"
									...
									<c:if test="${form.getData().resultat == 'errorDao'}">
										<div class="form-group">
											<div class="alert alert-danger alert-dismissible fade in"
												style="text-shadow: 0 0px 0 #fff;" role="alert">
												<button type="button" class="close" data-dismiss="alert"
										...
										<div id="champ_competences">
											...
											<div class="col-md-4 col-sm-4 col-xs-12 input-group">
												<input type="number" class="form-control" id="pourcentage1"
													name="pourcentage1" value="0" size="20" maxlength="30"
													step="1" min="0" max="100" required/>
												<div class="input-group-addon">%</div>
											</div>

											<span class="text-danger">${form.getData().erreurs['competence']}</span>
											<span class="text-danger">${form.getData().erreurs['pourcentage']}</span>
									...
									<c:if test="${empty examen}">
										...
										<select class="form-control" name="choixExamen"
											...
											<c:forEach var="examen" items="${examens}">
												<c:if test="${examen.autoEvaluation == false}">
													<option value="<c:out value="${examen.nom}"/>">
														<c:out
															value="${examen.nom} [${examen.matiere.nom}]" />
													</option>
												</c:if>
											</c:forEach>
										</select>
									...
									<c:if test="${form.getData().erreurs['examen'] != null}">
										<div class="alert alert-danger alert-dismissible fade in"
											style="text-shadow: 0 0px 0 #fff;" role="alert">
											<button type="button" class="close" data-dismiss="alert"
												aria-label="Close">
											...
											<c:out value="${form.getData().erreurs['question']}" />
										</div>
									</c:if>

									<br>

									<c:if test="${form.getData().erreurs['question'] != null}">
										<div class="alert alert-danger alert-dismissible fade in"
											style="text-shadow: 0 0px 0 #fff;" role="alert">
											<button type="button" class="close" data-dismiss="alert"
												aria-label="Close">
									...
									<div class="form-group">
										<input class="form-control" type="text" id="question"
											name="question" value="" size="200" maxlength="2000" required/>
									</div>

									<c:if test="${form.getData().erreurs['reponse'] != null}">
										<div class="alert alert-danger alert-dismissible fade in"
											style="text-shadow: 0 0px 0 #fff;" role="alert">
											<button type="button" class="close" data-dismiss="alert"
												aria-label="Close">
											...
											<c:out value="${form.getData().erreurs['reponse']}" />
										</div>
									</c:if>

									<label>Réponse : </label>
									<div class="form-group">
										<input class="form-control" type="text" id="reponse"
											name="reponse" value="" size="200" maxlength="2000" required/>
									</div>

									<c:if test="${form.getData().erreurs['points'] != null}">
										<div class="alert alert-danger alert-dismissible fade in"
											style="text-shadow: 0 0px 0 #fff;" role="alert">
											<button type="button" class="close" data-dismiss="alert"
												aria-label="Close">
											...
											<c:out value="${form.getData().erreurs['points']}" />
										</div>
									</c:if>
									...
									<div class="form-group">
										<input class="form-control bfh-number" type="text" id="points"
											name="points" value="0" value="0" data-min="0" data-max="100"
											data-wrap="true" required/>
									</div>
