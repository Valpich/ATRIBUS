...
<body class="nav-md">
							...
							<div class="x_content">
								...
								<c:if test="${not empty fileName}">
									<div class="alert alert-success alert-dismissible fade in"
										...
										<c:out value="Le fichier ${fileName} a bien été uploadé !" />
									</div>
								</c:if>
								...
								<c:if test="${empty matieres}">
									<div class="alert alert-danger alert-dismissible fade in"
										...
										<c:out
											value="Aucune matiere n'est actuellement enregistrée sur la base de données" />
									</div>
								</c:if>

								<c:if test="${not empty matieres}">
									<form action="EnvoyerRessource" method="post"
										enctype="multipart/form-data" novalidate>
										<c:if test="${not empty matieres}">

											<label>Veuillez choisir la matiere associée à cette
												ressource</label>
											...
											<c:if test="${not empty form.erreurs['file']}">
												<div class="alert alert-danger alert-dismissible fade in"
													style="text-shadow: 0 0px 0 #fff;" role="alert">
													<button type="button" class="close" data-dismiss="alert"
														aria-label="Close">
												...
												<div class="item form-group">
													...
													<input type="file" id="file" name="file" class="filestyle"
														...
														data-iconName="glyphicon glyphicon-open-file" required>
												</div>
	...
	<script src="<c:url value="/resources/js/validator/validation.js"/>"></script>
