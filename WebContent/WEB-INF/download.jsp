...
<head>
  ...
  <title>Télécharger une ressource</title>
							...
							<br>
								<c:if test="${not empty ressources}">
									<form action="download" method="post">
										<label>Veuillez choisir une ressource</label>
										<select class="form-control" name="choixRessource" id="choixRessource" required>
										...
										<div class="text-center">
											<button type="submit" class="btn btn-success btn-block">Télécharger la ressource</button>
										</div>
								...
								<c:if test="${empty ressources}">
									<form action="upload" method="get">
										<div class="alert alert-danger alert-dismissible fade in" style="text-shadow: 0 0px 0 #fff;" role="alert">
											...
											<c:out value="Aucune ressource n'est actuellement enregistrée sur le serveur" />
										</div>
										<div class="text-center">
											<button type="submit" class="btn btn-success btn-block">Ajouter une ressource</button>
										</div>
									</form>
								</c:if>
                ...
                <div class="clearfix"></div>
				 ...
				 <footer>
					 <div class="pull-right">
						 Atribus - Projet GL - Groupe n°2 - 2016
					 </div>
					 <div class="clearfix"></div>
				 </footer>
				 <!-- /footer content -->   
