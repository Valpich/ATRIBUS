						...
						<div class="x_panel tile">
							...
							<c:if test="${not empty error}">
								<div class="alert alert-danger alert-dismissible fade in"
									...
									<c:out
										value="Echec lors de la suppression de certaines notifications" />
								</div>
							</c:if>
							<c:if test="${not empty succes}">
								<div class="alert alert-success alert-dismissible fade in"
									...
									<c:out value="Succès de la suppression de(s) notification(s)" />
								</div>
							</c:if>
							<c:if test="${not empty vide}">
								<div class="alert alert-warning alert-dismissible fade in"
									...
									<c:out value="Vous n'aviez coché aucune notification" />
								</div>
							</c:if>
							...
							<div class="x_content">
										...
										<table
											...
											<thead>
												<tr>
													...
													<th class="column-title" style="display: table-cell;">Envoyée
														par</th>
													<th class="column-title" style="display: table-cell;">Date</th>
													<th class="column-title" style="display: table-cell;">Message</th>
													<th class="bulk-actions" style="display: none;">Envoyée
														par</th>
													<th class="bulk-actions" style="display: none;">Date</th>
													<th class="bulk-actions" style="display: none;">Message</th>
												</tr>
											</thead>
											...
											<tbody class="recherche">
												...
												<c:forEach
													items="${sessionScope.sessionUtilisateur.get(0).notifications}"
													var="notification">
								...
								<c:if
									test="${empty sessionScope.sessionUtilisateur.get(0).notifications}">
