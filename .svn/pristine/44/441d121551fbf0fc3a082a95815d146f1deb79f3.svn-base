...
public class EvolCompetence {
  ...
  @Test
  public void testEvolCompetence() throws Exception {
    ...
    driver.findElement(By.cssSelector("input.form-control.input-sm")).sendKeys("Youssef");
