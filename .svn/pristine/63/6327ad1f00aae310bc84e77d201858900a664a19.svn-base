...
<head>
	...
	<title>Afficher compétences UE</title>
					...
					<div class="col-md-12 col-sm-12 col-xs-6">
						<div class="x_panel tile">
							<div class="x_title">
								...
								<h2>Afficher les compétences liées à une UE</h2>
							...
							<div class="x_content">
								...
								<c:if test="${not empty ues}">
									...
									<form method="post" action="AfficherCompetenceUE">
										...
										<div class="form-group">
											<c:if test="${not empty ues}">
												<select class="form-control select2" name="nomUe" id="nomUe" required>
										...
										<div class="form-group">
											<button type="submit" class="btn btn-success btn-block">Afficher les compétences liées à cette UE</button>
										</div>
								...
								<c:if test="${empty ues}">
									<c:if test="${empty listeCompetences}">
									<div class="alert alert-danger alert-dismissible fade in" style="text-shadow: 0 0px 0 #fff;" role="alert">
										<button type="button" class="close" data-dismiss="alert" aria-label="Close">
											<span aria-hidden="true">×</span>
										</button>
										<c:out value="Cette UE ne contient aucune compétence" />
									</div>
																		<div class="form-group">
										<form method="get" action="AfficherCompetenceUE">
											<button type="submit" class="btn btn-primary btn-block">Revenir à la liste des UE</button>
										</form>
									</div>
									</c:if>
								</c:if>							
								<c:if test="${not empty listeCompetences}">
