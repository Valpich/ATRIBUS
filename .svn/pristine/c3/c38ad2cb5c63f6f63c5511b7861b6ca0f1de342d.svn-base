...
public class AddExamenFormTest {
  ...
  public void ajouterBonExamen() {
    ...
    this.examen = this.form.addExamen(request);

    assertNotNull(this.examen);
    assertEquals(this.examen.getNom(), nomExamen, "Le nom de l'examen est correcte.");
