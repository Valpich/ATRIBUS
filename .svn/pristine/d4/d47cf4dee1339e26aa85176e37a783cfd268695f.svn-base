...
public class SuggerCompErm {
  ...
  @Test
  public void testSuggerCompErm() throws Exception {
    driver.get(baseUrl + "/ATRIBUS/");
    driver.findElement(By.linkText("Compétences")).click();
    driver.findElement(By.linkText("Suggerer compétence (ERM)")).click();
    driver.findElement(By.id("commentaire")).clear();
    driver.findElement(By.id("commentaire")).sendKeys("Savoir Travailler en Agile");
