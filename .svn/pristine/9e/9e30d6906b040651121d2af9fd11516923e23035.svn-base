...
var validator = (function($){
    ...
    */
    message = {
        ...
        min             : 'Entrée trop courte',
        max             : 'Entrée trop longue',
        number_min      : 'Nombre trop faible',
        number_max      : 'Nombre trop haut',
        url             : 'URL invalide',
        number          : 'N\'est pas un nombre',
        email           : 'Adresse email non valide',
        email_repeat    : 'Les deux adresses mails sont différentes',
        password_repeat : 'Les mots de passes sont différents,',
        repeat          : 'Les deux champs sont différents',
        complete        : 'Entrée incomplete',
        select          : 'Merci de choisir une option'
    };
