...
public class ConsulterNotes {
  ...
  @Test
  public void testConsulterNotes() throws Exception {
    ...
    driver.findElement(By.cssSelector("input.form-control.input-sm")).sendKeys("Micropro");
