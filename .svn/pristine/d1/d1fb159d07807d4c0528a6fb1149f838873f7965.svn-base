...
public class ModifCompUE {
  ...
  @Test
  public void testModifCompUE() throws Exception {
    ...
    new Select(driver.findElement(By.id("listeUe"))).selectByVisibleText("Anglais");
    new Select(driver.findElement(By.id("listeCompetence"))).selectByVisibleText("Solutions et recommandations");
