								...
								<form method="post" action="ModifierExamen">
									...
									<div class="form-group">
										<c:if test="${empty examen}">
											...
											<select class="form-control" data-live-search="true" name="choixExamen" id="choixExamen" required>
										...
										<c:if test="${not empty examen}">
											...
											<div class="form-group">
											<select class="form-control" name="choixMatiere" id="choixMatiere" required>
