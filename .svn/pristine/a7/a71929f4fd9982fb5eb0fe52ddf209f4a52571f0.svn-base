...
<head>
	...
	<title>Un petit soucis est servenu :(</title>
      ...
      <div class="col-md-12">
        <div class="col-middle">
          <div class="text-center">
            <h1 class="error-number">0</h1>
            <h2>Une erreur est arrivée.</h2>
            <p>Une erreur imprévue est survenue, merci de réessayer plus tard.</p>
