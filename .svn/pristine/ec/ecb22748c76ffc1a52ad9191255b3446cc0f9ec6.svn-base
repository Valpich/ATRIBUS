...
public class ConsulterRessource {
  ...
  @Test
  public void testConsulterRessource() throws Exception {
    driver.get(baseUrl + "/ATRIBUS/");
    driver.findElement(By.linkText("Ressources")).click();
    driver.findElement(By.linkText("Consulter l'historique d'utilisation des ressoruces")).click();
