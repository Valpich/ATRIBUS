...
public class MatAfficherComp {
  ...
  @Test
  public void testMatAfficherComp() throws Exception {
    driver.get(baseUrl + "/ATRIBUS/");
    driver.findElement(By.linkText("Matières")).click();
    driver.findElement(By.xpath("//div[@id='sidebar-menu']/div/ul/li[5]/ul[2]/li/a")).click();
